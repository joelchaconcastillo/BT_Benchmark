...
{
   int n = x.size();
   double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-10;
   for(int j = 2; j <= n; j++)
   {
...
{
   int n = x.size();
   double sum1 = 0.0, sum2 = 0.0, theta = 0.5;
   for(int j = 2; j <= n; j++)
   {
      double yj = x[j-1] - sin((j*M_PI)/(2.0*n));
...
{
   int n = x.size();
   double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-4;
   for(int j = 2; j <= n; j++)
   {
...
{
   int n = x.size();
   double sum1 = 0.0, sum2 = 0.0, theta = 1.0e-3;
   for(int j = 2; j <= n; j++)
   {
